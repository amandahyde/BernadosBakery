...
namespace BernadosBakery.Controllers
{
    public class DrinksController : Controller
    {
        ...
        public DrinksController(BakeryContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ShortDesc,LongDesc,Price,SalePrice,IsDrinkOfWeek")] Drink drink)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,ShortDesc,LongDesc,Price,SalePrice,IsDrinkOfWeek")] Drink drink)
        {
            if (id != drink.Id)
            {
                return NotFound();
